...
import { BoldDirective2 } from "./bold.directive2";
import { BoldDirective3 } from "./bold.directive3";

@NgModule({
    imports:        [ BrowserModule, FormsModule], // set of another modules are used in current module
    declarations:   [ AppComponent, BoldDirective, BoldDirective2, BoldDirective3 ], // set of view classes of current module (There are three type of view classes in Angular: components, directives, pipes)
