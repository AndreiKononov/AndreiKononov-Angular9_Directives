...
@NgModule({
    ...
    declarations:   [ AppComponent, BoldDirective ], // set of view classes of current module (There are three type of view classes in Angular: components, directives, pipes)
